...
env = environ.FileAwareEnv(
    ...
    INSTANCE_WILDCARD_DOMAIN=(str, 'localhost'),
...
INSTANCE_WILDCARD_DOMAIN = env.str('INSTANCE_WILDCARD_DOMAIN')
HOSTNAME_INSTANCE_DOMAINS = env.list('HOSTNAME_INSTANCE_DOMAINS')
if INSTANCE_WILDCARD_DOMAIN and INSTANCE_WILDCARD_DOMAIN not in HOSTNAME_INSTANCE_DOMAINS:
    HOSTNAME_INSTANCE_DOMAINS.append(INSTANCE_WILDCARD_DOMAIN)
