...
class DatasetSchemaPermissionPolicy(InstanceConfigScopedPermissionPolicy[DatasetSchema, DatasetSchemaQuerySet]):
...
class DataSourcePermissionPolicy(InstanceConfigScopedPermissionPolicy[DataSource, DataSourceQuerySet]):
