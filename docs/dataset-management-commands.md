...
```bash
python -m tools.upload_new_dataset -i "$PATHS_DATA/models/mainz/datasets/mainz_mp100_measures.csv" ...
python -m tools.upload_new_dataset -i ../paths-data/models/mainz/datasets/mainz_mp100_measures.csv ...
```
