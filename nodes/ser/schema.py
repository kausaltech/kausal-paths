...
from .node_ser import EdgeNodePort, EdgeSer, NodeSer, PathsModelConfig
...
class NodeType:
    if TYPE_CHECKING:
        @staticmethod
        def from_pydantic(instance: NodeSer) -> NodeType:
            return NodeType.from_pydantic(instance)
...
class NodesQuery:
    ...
    def model_config(self, id: strawberry.ID) -> PathsModelConfigType:
        ...
        return PathsModelConfigType.from_pydantic(pmc)
