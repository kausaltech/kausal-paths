...
def get_source_default_value_scaling(_measure_template_uuid: str, per_capita: bool) -> str | None:
    if not per_capita:
        return None
    return 'population'
...
def get_effective_default_value_scaling(_template: Any, requested_scaling: str | None) -> str | None:
